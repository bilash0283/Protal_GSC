      ...
      if ($_SESSION['role'] == 1) {
        ...
        <div class="row mt-3">
          <div class="col-md-6">
            ...
            <dx:BootstrapPieChart ID="PieChartSeries" runat="server" DataSourceUrl="~/jsondata/ChartTypes/pie.json"
              TitleSettings-Text="Countries in the world by population (2017)">
              <SeriesCollection>
