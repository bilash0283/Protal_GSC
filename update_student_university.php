                      ...
                      <div class="row">
                          ...
                          <?php 
                            ...
                            if ($university != '') { ?>
                              <div class="form-group">
                                ...
                                <input type="text" name="gscuniversity" value="<?php echo $university;?>" id="inputClientCompany" class="form-control">
                              </div>
                          <?php  } else { ?>
                              <div class="form-group">
                                <label for="inputClientCompany">Preferable University</label>
                                <input type="text" name="gscuniversity" value="<?php echo $gscuniversity;?>" id="inputClientCompany" class="form-control">
                              </div>
                         <?php }
                        ...
                        <div class="col-md-6">
                          ...
                          <div class="form-group">
                              ...
                              <input type="text" name="subject" value="<?php echo $subject; ?>" id="inputClientCompany" class="form-control">
                            </div>
