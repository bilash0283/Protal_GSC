                        ...
                        <div class="col-md-6">
                          <div class="card-body">
                            <div class="form-group">
                              ...
                              <input type="text" name="name" value="<?php echo $sname; ?>" id="inputName" class="form-control" required>
                            </div>
                        ...
                        <div class="col-md-6">
                          <div class="card-body">
                            ...
                            <div class="form-group">
                              ...
                              <input type="text" name="passport" value="<?php echo $spassport; ?>" id="inputName" class="form-control" required>
                            </div>

                            <div class="form-group">  
                              <label for="inputProjectLeader">Please upload all Missing/Updated documents in a single PDF File. (CV, Passport, All Academic Certificates and Transcript,
