  ...
  <div class="content-wrapper">
    ...
    <section class="content">
      ...
      <div class="container">
        <div class="row">
            <div class="col-md-12">
            <div class='alert alert-danger mt-2'>Insert All Qualification File in One PDF Format!</div>
            <div class='alert alert-danger mt-2'>Insert All Information Of Student Correctly!</div>
            <br>
            </div>
            <div class="col-md-12">
