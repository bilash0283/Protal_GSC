      ...
      <div class="content-wrapper">
        ...
        <div class="content-header">
          <div class="container-fluid">
            <div class="row mb-2">
              <div class="col-sm-6">
                <h1 class="m-0">All New Student</h1>
              </div><!-- /.col -->
              <div class="col-sm-6">
          ...
          <div class="row">
            <div class="col-md-12">
                <table class="table">
                  ...
                  <tbody>
                    <?php
                      $agents = "SELECT * FROM agents WHERE role='4' ORDER BY id DESC";
                              ...
                              <div class="modal-dialog">
                                <div class="modal-content">
                                  ...
                                  <div class="modal-body">
                                    <p>Are you sure to delete <strong><?php echo $email?></strong></p>
                                  </div>
            ...
            <?php
              if(isset($_GET['delete'])){
                ...
                $delete_sql = "DELETE FROM agents WHERE email = '$delete_email'";
